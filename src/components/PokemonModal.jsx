export default function PokemonModal({ activePokemon, onClose, onPlayCry }) {
  ...
  return (
    ...
    >
      <div 
        className="w-full max-w-xl p-6 bg-red-600 border-4 border-black rounded-lg shadow-[8px_8px_0_0_#000]"
      ...
      >
        ...
        <button 
          onClick={onPlayCry}
          className="w-full py-2 mt-4 font-bold text-white uppercase bg-blue-500 border-4 border-black hover:bg-blue-400 active:translate-y-1 shadow-[2px_2px_0_0_#000] cursor-pointer"
        >
          Play Cry
        </button>
        ...
        <button 
          onClick={onClose}
          className="w-full py-2 mt-4 font-bold text-black uppercase bg-yellow-400 border-4 border-black hover:bg-yellow-300 active:translate-y-1 shadow-[2px_2px_0_0_#000] cursor-pointer"
        >
          Close
        </button>
      </div>
